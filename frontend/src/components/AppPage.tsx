                            ...
                            {LOC_TABS.map((t) => {
                                ...
                                return (
                                    <button
                                        ...
                                        onMouseEnter={e => { if (!active) { e.currentTarget.style.background = "rgba(0,0,0,0.06)"; e.currentTarget.style.borderColor = "rgba(0,0,0,0.16)"; }}}
                      ...
                      {coords.lat.toFixed(5)}, {coords.lng.toFixed(5)}
                        ...
                        {locSource === "manual" && (
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                                {[
                                    { label: "Latitude", val: manualLat, set: setManualLat, placeholder: "52.08765" },
                                    { label: "Longitude", val: manualLng, set: setManualLng, placeholder: "5.83421" },
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            borderRadius: 5, transition: "all 0.14s", outline: "none",
                                        }}
